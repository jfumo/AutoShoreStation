...
setwd("~/AutoShoreStation/pH")
library(ncdf4)
rawData=data.frame(time=as.POSIXct(ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),"time"),origin='1970-01-01 00:00:00'),ph_counts=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'ph_counts'),ph_voltage=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'ph_voltage'),ph_raw=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'ph_raw'),temp_counts=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'temp_counts'),thermistor_voltage=ncvar_get(nc_open("http://sccoos.org/thredds/dodsC/autoss/005_newport_pier-2018.nc"),'thermistor_voltage'),thermistor_raw=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'thermistor_raw'),temperature=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'temperature'),ph=ncvar_get(nc_open("http://thredds.sccoos.org/thredds/fileServer/autoss/005_newport_pier-2018.nc"),'ph'))
